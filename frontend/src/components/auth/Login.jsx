    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="bg-white shadow flex items-center justify-between px-6 py-4">
        <Link to="/" className="flex items-center space-x-2">
          <img src="/vite.svg" alt="CeyHarvest Logo" className="h-8 w-8" />
          <span className="text-xl font-bold text-green-600">CeyHarvest</span>
        </Link>
        <div className="flex items-center space-x-6">
          ...
          <Link to="/help" className="text-gray-700 hover:text-green-600 font-medium">Help</Link>
        </div>
      </nav>
