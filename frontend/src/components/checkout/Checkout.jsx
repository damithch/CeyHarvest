...
const Checkout = () => {
  ...
  const processOrder = async () => {
    ...
    try {
      ...
      const paymentResponse = await fetch('http://localhost:8080/api/checkout/create-payment-intent', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
      ...
      // Step 3: Process payment (in a real implementation, this would integrate with Stripe)
      // For now, we'll simulate successful payment
      await new Promise(resolve => setTimeout(resolve, 2000)); // Simulate processing time

      const confirmResponse = await fetch('http://localhost:8080/api/checkout/confirm-payment', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        ...
        body: JSON.stringify({
          ...
          paymentMethodId: 'pm_mock_success', // Mock payment method ID
          orderId: orderId
        })
      });
              ...
              {paymentMethod === 'card' && (
                <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-md">
                  <p className="text-sm text-blue-800">
                    <strong>Demo Mode:</strong> This is a mock payment integration. 
