...
const EnhancedRegister = () => {
  ...
  const sendVerificationCode = async () => {
    ...
    try {
      ...
      setSuccess(`Verification code sent to your email: ${formData.email}`);
      
    } catch (error) {
      console.error('Verification send error:', error);
      // For development, still proceed with the code
      setSuccess(`Verification code: ${code} (Development mode)`);
    }
  };
